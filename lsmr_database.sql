...
--
-- Host: localhost    Database: lsmr_database
-- ------------------------------------------------------
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `checkpoint1` (
  `Checkpoint1Id` int NOT NULL AUTO_INCREMENT,
  `TruckId` int NOT NULL,
  `LuggageId` int NOT NULL,
  `Checkpoint1Date` date NOT NULL,
  `Checkpoint1Time` varchar(45) NOT NULL,
  PRIMARY KEY (`Checkpoint1Id`),
  KEY `TruckId_idx` (`TruckId`),
  KEY `LuggageId_idx` (`LuggageId`),
  CONSTRAINT `LuggageId` FOREIGN KEY (`LuggageId`) REFERENCES `luggage` (`LuggageId`),
...
LOCK TABLES `checkpoint1` WRITE;
/*!40000 ALTER TABLE `checkpoint1` DISABLE KEYS */;
INSERT INTO `checkpoint1` VALUES (1,2,2,'2023-06-05','12:24:34'),(2,1,2,'2023-05-07','08:47:43');
/*!40000 ALTER TABLE `checkpoint1` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `checkpoint2` (
  `CheckPoint2Id` int NOT NULL AUTO_INCREMENT,
  `ConveyerId` int DEFAULT NULL,
  `LuggageId` int DEFAULT NULL,
  `Checkpoint2Date` date DEFAULT NULL,
  `Checkpoint2Time` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`CheckPoint2Id`),
  KEY `luggage_cp2_idx` (`LuggageId`),
  KEY `ConveyerLaneName_idx` (`ConveyerId`),
  CONSTRAINT `ConveyerLaneName` FOREIGN KEY (`ConveyerId`) REFERENCES `conveyerlane` (`ConveyerLaneId`),
  CONSTRAINT `LuggageIdCP2` FOREIGN KEY (`LuggageId`) REFERENCES `luggage` (`LuggageId`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
LOCK TABLES `checkpoint2` WRITE;
/*!40000 ALTER TABLE `checkpoint2` DISABLE KEYS */;
INSERT INTO `checkpoint2` VALUES (1,0,1,'2023-06-18','11:28:05');
/*!40000 ALTER TABLE `checkpoint2` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `checkpoint3`
--

DROP TABLE IF EXISTS `checkpoint3`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `checkpoint3` (
  `CheckPoint3Id` int NOT NULL AUTO_INCREMENT,
  `LuggageId` int DEFAULT NULL,
  `StaffName` varchar(45) DEFAULT NULL,
  `LuggageStatus` varchar(45) DEFAULT NULL,
  `Checkpoint3Date` date DEFAULT NULL,
  `Checkpoint3Time` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`CheckPoint3Id`),
  KEY `LuggageIdCP3_idx` (`LuggageId`),
  KEY `StaffNameCP3_idx` (`StaffName`),
  CONSTRAINT `LuggageIdCP3` FOREIGN KEY (`LuggageId`) REFERENCES `luggage` (`LuggageId`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `checkpoint3`
--

LOCK TABLES `checkpoint3` WRITE;
/*!40000 ALTER TABLE `checkpoint3` DISABLE KEYS */;
/*!40000 ALTER TABLE `checkpoint3` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `checkpoint4`
--

DROP TABLE IF EXISTS `checkpoint4`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `checkpoint4` (
  `CheckPointId` int NOT NULL AUTO_INCREMENT,
  `LuggageId` int DEFAULT NULL,
  `LuggageStatus` varchar(45) DEFAULT NULL,
  `StaffName` varchar(45) DEFAULT NULL,
  `Checkpoint4Date` date DEFAULT NULL,
  `Checkpoint4Time` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`CheckPointId`),
  KEY `LuggageIdCP4_idx` (`LuggageId`),
  CONSTRAINT `LuggageIdCP4` FOREIGN KEY (`LuggageId`) REFERENCES `luggage` (`LuggageId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `checkpoint4`
--

LOCK TABLES `checkpoint4` WRITE;
/*!40000 ALTER TABLE `checkpoint4` DISABLE KEYS */;
/*!40000 ALTER TABLE `checkpoint4` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `flight` VALUES (1,'MH370','2023-01-01 22:14:59'),(19,'MASFLY','2023-01-02 14:23:11');
...
CREATE TABLE `luggage` (
  ...
  CONSTRAINT `Luggage_Flight_FK` FOREIGN KEY (`FlightId`) REFERENCES `flight` (`FlightId`),
  CONSTRAINT `Luggage_Passenger_FK` FOREIGN KEY (`PassengerId`) REFERENCES `passenger` (`PassengerId`),
  CONSTRAINT `Luggage_Staff_FK` FOREIGN KEY (`StaffId`) REFERENCES `staff` (`StaffId`),
  CONSTRAINT `Luggage_Truck_FK` FOREIGN KEY (`TruckId`) REFERENCES `truck` (`TruckId`)
...
INSERT INTO `luggage` VALUES (1,'Unclaimed',1,1,1,'2023-05-06','13:00','2023/05/06','13:20','2023/05/06','13:45','2023/05/06','14:00',1,1),(2,'Collected',2,1,2,'2023-05-06','13:00','2023/05/06','13:20','2023/05/06','13:45','2023/05/06','14:00',2,2);
...
INSERT INTO `truck` VALUES (1,'HBA2033'),(2,'HDD2043'),(3,'HSD9237'),(4,'HSI2936'),(5,'HLW0293'),(6,'HPE0284');
...
-- Dump completed on 2023-06-18 11:54:00
